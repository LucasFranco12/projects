...
if __name__ == "__main__":
    ...
    test_angles = [0,1.2,.225,-.490,1.127,0]  # Base fixed + 4 revolute joints + end fixed
    ...
    ik_result = inverse_kinematics_test(target_position, [0, .7, 0, .7], test_angles)
    ...
    custom_position = np.array([0.09325278, -0.01494234, 0.01882395])  # Custom position
    custom_orientation = np.array([0, 0, 0, 1])  # Identity orientation (no rotation)
